								...
								<div class="col-sm-12">
									...
									<nav class="rs-menu">
                                        ...
                                        <li class="menu-item-has-children"> <a href="{{ route('about') }}">About Us</a>
                                            ...
                                            <li class="menu-item-has-children"> <a href="{{ route('events') }}">News</a>
                                            </li>
                                    ...
                                    <form action="" method="post">
                                            ...
                                            <button type="submit" class="btn btn-danger   float-right" style="color:black">search</button>

                                        {{-- <div class="right-bar-icon rs-offcanvas-link text-right">
                                            <a type="text" name="q" id="q" class="hidden-xs rs-search" data-target=".search-modal" data-toggle="modal" href="#"><i class="fa fa-search"></i></a>
