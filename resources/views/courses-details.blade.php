                	    			...
                	    			<div class="col-md-6 mobile-mb-20">
                	    				...
                	    				<div class="instructor-inner">
                	    					<div class="instructor-img">
                	    						<img src="{{ asset(' images/teachers/2.jpg') }}" alt="Teachers Images" />
                	    					</div>
                        ...
                        @foreach ($courses as $course)
							<div class="cource-item">
			                    ...
			                    <div class="course-body">
			                    	<a href="#" class="course-category">{{ $course->secondName }}</a>
			                    	<h4 class="course-title">{{ $course->name }}</a></h4>
			                    ...
			                    <div class="course-footer">
			                    	<div class="course-time">
			                    		...
			                    		<span class="desc">{{ $course->time }} months</span>
									</div>
									<hr>
									<div class="course-student">
			                    		<span class="label">Course Student</span>
			                    		<span class="desc">{{ $course->users_count }}</span>
			                    	</div>
								</div>
								
								<div class="event-btn">
									<a href=" {{ route('course-details' , ['id' => $course->id]) }} " class="btn btn-success">View Course</a>
								</div>
			                </div>	
							@endforeach					
