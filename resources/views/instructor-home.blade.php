...
<!-- Mirrored from keenitsolutions.com/products/html/edulearn/edulearn-demo/instructor-home.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 May 2020 22:10:57 GMT -->
<head>
        <!-- meta tag -->
        <meta charset="utf-8">
    ...
    <body class="instructor-home">
                                        ...
                                        <ul class="nav-menu">
                                            ...
                                            <li class="current-menu-item current_page_item menu-item-has-children"> <a href="#" class="home">Home</a>
                                             <ul class="sub-menu">
                                               ...
                                               <li class="active"><a href="instructor-home.html">Home Instructor</a> </li>
		...
		<div class="rs-banner-section">
            <img src="images/slider/banner.jpg" alt="" />
            <div class="banner-inner">
                <div class="container">
                    <div class="banner-text">
                        <div class="sl-sub-title">Hi, I Am</div>
                        <h1 class="banner-title">Stephen Smith</h1>
                        <h4 class="content">I must explain to you how all this  mistaken  idea of denouncing  pleasure and praising  pain was born and I will give  you a complete account of the system</h4>
                        <div class="btn-area pt-20">
                            <a href="#" class="readon">Enroll NOW</a>
                       </div>
                    </div>
                </div>
            </div>
        ...
        <div id="rs-about-me" class="rs-about sec-spacer">
            <div class="container">
                <div class="row rs-vertical-middle">
                    ...
                    <div class="col-lg-6 col-md-12 mb-pt-50">
                    	<div class="sec-title mb-30">
                		    <h2>ABOUT ME !</h2>      
                			<p>I’m Stephen Smith, Ast. Professior</p>
                    	</div>
                    	<div class="des">
                    		Suspendisse ex neque, sollicitudin in velit eu, luctus gravida nunc. Nulla pulvinar risus sed metus euismod sodales ut sed nisi. Nulla posu ere suscip it finibus. Quis que placerat vitae lacus ut scelerisque.
                    	</div>
                    	<div class="rs-team-single mt-80">
			        		<div class="progress rs-progress">
								<div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="95" aria-valuemin="0" aria-valuemax="100" style="width:95%">
									<span class="pb-label">Chemestry</span>
			        		...
			        		<div class="progress rs-progress">
								<div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="88" aria-valuemin="0" aria-valuemax="100" style="width:88%">
									<span class="pb-label">Mathematics </span>
	                		...
	                		<div class="progress rs-progress">
								<div class="progress-bar progress-bar-success" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width:75%">
									<span class="pb-label">Physics </span>
        ...
        <div class="rs-counter rs-counter-style2  pt-100 pb-70 bg3">
            <div class="container">
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="rs-counter-list">
                            ...
                            <h2 class="counter-number plus">1200</h2>                  
                            <h4 class="counter-desc">ENROLLED STUDENTS</h4>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="rs-counter-list">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="rs-counter-list">
                            ...
                            <h2 class="counter-number plus">120</h2>                  
                            <h4 class="counter-desc">REVIEWS</h4>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                        <div class="rs-counter-list">
                            ...
                            <h2 class="counter-number plus">375</h2>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="courses-item">
                                ...
                                <h4 class="courses-title"><a href="#">Online Course Facilities</a></h4>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="courses-item">
                                ...
                                <h4 class="courses-title"><a href="#">Modern Book Library</a></h4>
                                <p>At vero eos et accusamus et iusto odiodignissimos laborumducimus qui blanditiis voluptatum dolor sit</p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="courses-item">
                                ...
                                <h4 class="courses-title"><a href="#">Be Industrial Leader</a></h4>
                                <p>At vero eos et accusamus et iusto odiodignissimos laborumducimus qui blanditiis voluptatum dolor sit</p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="courses-item">
                                ...
                                <h4 class="courses-title"><a href="#">Programming Courses</a></h4>
                                <p>At vero eos et accusamus et iusto odiodignissimos laborumducimus qui blanditiis voluptatum dolor sit</p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="courses-item">
                                ...
                                <h4 class="courses-title"><a href="#">Foreign Languages</a></h4>
                                <p>At vero eos et accusamus et iusto odiodignissimos laborumducimus qui blanditiis voluptatum dolor sit</p>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <div class="courses-item">
                                ...
                                <h4 class="courses-title"><a href="#">Alumni Directory</a></h4>
                                <p>At vero eos et accusamus et iusto odiodignissimos laborumducimus qui blanditiis voluptatum dolor sit</p>
                            </div>
                        </div>
                    </div>
        ...
        <!-- Latest News Start -->
        <div id="rs-latest-news" class="rs-latest-news sec-spacer sec-color">
            <div class="container">
                <div class="row rs-vertical-middle">
                    <div class="col-lg-6">
                        <div class="sec-title mb-50">
                        ...
                        <div class="view-btn mt-30">
                            <a class="readon" href="blog.html">View All Post</a>
                        </div>
                    </div>
                    <div class="col-lg-6 mb-pt-50">
                         <!-- Calltoaction Start -->
                        <div id="rs-webdevelopment-course" class="rs-webdevelopment-course bg9 sec-spacer">
                            <div class="container">
                                <div class="rs-cta-inner text-center">
                                    <div class="cta-sec mb-50 text-center">
                                        <h2 class="cta-title">WEB DEVLOPMENT COURSE</h2>      
...
<!-- Mirrored from keenitsolutions.com/products/html/edulearn/edulearn-demo/instructor-home.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 22 May 2020 22:11:13 GMT -->
</html>